...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference("Department.count") do
      post departments_url, params: { department: { building_id: @department.building_id, number: @department.number } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { building_id: @department.building_id, number: @department.number } }
